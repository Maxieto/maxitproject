    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light bg-white" id="navbar-main">
      <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="<?php echo e(url('/')); ?>">
          <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/brand/dark.png')); ?>" id="navbar-logo" style="height: 100px;">
        </a>
            ...
            <div class="col-sm-8 col-lg-6 col-xl-5 order-lg-2">
              <div class="card shadow zindex-100 mb-0">
                <div class="card-body px-md-5 py-5">
                  ...
                  <a href="<?php echo e(url('user/register')); ?>" class="small font-weight-bold">Create account</a>
                  </div>
              </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\maxitproject\core\resources\views/templates/minimal/user/auth/login.blade.php ENDPATH**/ ?>