    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light bg-white" id="navbar-main">
      <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="<?php echo e(url('/')); ?>">
          <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/brand/dark.png" id="navbar-logo')); ?> " style="height: 50px;">
        </a>
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" href="<?php echo e(url('plan')); ?>">
                          Plane
                        </a>
                      </li>
                      <li>
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" href="<?php echo e(url('/user/login')); ?>">
                          Login
                        </a>
                      </li>
                      <li>
  ...
  <div class="main-content">
    <section class="slice slice-lg min-vh-100 d-flex align-items-center bg-section-secondary">
      ...
      <div class="bg-absolute-cover bg-size--contain d-none d-lg-block">
        <figure class="w-100">
          <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/svg/backgrounds/bg-3.svg')); ?>" class="svg-inject">
        </figure>
      </div>
                 ...
                 <?php echo csrf_field(); ?>
                    <?php if(isset($reference)): ?>
                        <div class="form-group">
                            ...
                            <i class="fas fa-user-circle" > Referred  by </i>
                            </label>
                    ...
                    <div class="form-group">
                      <label class="form-control-label"><?php echo app('translator')->get('First Name'); ?> </label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-user"></i>
                               </span>
                        </div>
                        <input type="text" class="form-control"  value="<?php echo e(old('firstname')); ?>"  name="firstname"  id="input-password" placeholder="<?php echo app('translator')->get('First Name'); ?>">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control"  value="<?php echo e(old('lastname')); ?>"  name="lastname"  id="input-password" placeholder="<?php echo app('translator')->get('Last Name'); ?>">
                        <div class="input-group-append">
                          <span class="input-group-text">
                          <i class="fas fa-user"></i>
                          </span>
                    ...
                    <div class="form-group">
                      <label class="form-control-label"><?php echo app('translator')->get('Username'); ?></label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-user"></i></span>
                        </div>
                         <input type="text" required class="form-control" id="input-email" name="username" value="<?php echo e(old('username')); ?>"  placeholder="<?php echo app('translator')->get('Username'); ?>">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="form-control-label"><?php echo app('translator')->get('E-mail Address'); ?> </label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-user"></i></span>
                        </div>
                         <input type="email" required class="form-control" id="input-email" name="email"  value="<?php echo e(old('email')); ?>" placeholder="<?php echo app('translator')->get('E-mail Address'); ?>">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                            ...
                            <input type="tel" class="form-control pranto-control" id="phone" name="mobile"
                                   value="<?php echo e(old('mobile')); ?>" placeholder="<?php echo app('translator')->get('Your Contact Number'); ?>" required>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="form-control-label"><?php echo app('translator')->get('Password'); ?></label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                        <!-- <input type="password" class="form-control" id="input-password" placeholder="********"> -->
                        <input type="password" name="password" value="<?php echo e(old('password')); ?>" class="form-control" id="myInput"   placeholder="<?php echo app('translator')->get('Password'); ?>" required >
                    ...
                    <div class="form-group">
                      <label class="form-control-label"><?php echo app('translator')->get('Retype Password'); ?> </label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                    ...
                    <div class="my-4">
                      ...
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input "  required id="check-privacy">
                  ...
                  <a href="<?php echo e(url('user/login')); ?>" class="small font-weight-bold">Sign in</a></div>
              </div>
            </div>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/user/auth/register.blade.php ENDPATH**/ ?>