            ...
            <div class="col-lg-6  col-md-6 ">
                <form method="POST" action="<?php echo e(route('user.document_store')); ?>"  enctype="multipart/form-data" >
                 ...
                 <div class="col-lg-6  col-md-6 ">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-form-label"><?php echo app('translator')->get('Your identity verifcation back image '); ?></label>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/user/auth/authorize_document.blade.php ENDPATH**/ ?>