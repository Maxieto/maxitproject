        ...
        <div class="account--section sign-in-section active relative">
           <div class="container-fluid">
             <div class="account--area">
                <h4 class="title text-center text-danger"><?php echo e('Reset Password'); ?></h4>
             </div>
          </div>
       </div>
            ...
            <div class="col-lg-7 offset-md-3   col-md-7 offset-lg-3  ">
                ...
                <form method="POST" action="<?php echo e(route('user.password.update')); ?>" >
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-form-label"><?php echo app('translator')->get('New Password'); ?></label>
                        <input type="password" class="form-control" id="password" placeholder="<?php echo app('translator')->get('New Password'); ?>" name="password" required="" value="">
                    </div>

                    <div class="form-group">
                        <label for="inputEmail3" class="col-form-label"><?php echo app('translator')->get('Retype New Password'); ?></label>
                        <input type="password" class="form-control" id="password_confirmation" placeholder="<?php echo app('translator')->get('Confirm Password'); ?>" name="password_confirmation" required="" value="">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="remember mr-5">
                            <label class="form-check-label" for="gridCheck1">
                                <a href="<?php echo e(route('user.login')); ?>" ><?php echo app('translator')->get('Login Here'); ?></a>
                            </label>
                        </div>
                    </div>
                </form>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/user/auth/passwords/reset.blade.php ENDPATH**/ ?>