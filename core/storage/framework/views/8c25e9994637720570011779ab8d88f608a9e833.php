              ...
              <div class="card shadow zindex-100 mb-0">
                <div class="card-body px-md-5 py-5">
                  ...
                  <span class="clearfix"></span>
                    <form  role="form"action="<?php echo e(route('user.login')); ?>" method="POST"  class="account-form" id="recaptchaForm">
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" id="exampleInputUsername"  name="username" value="<?php echo e(old('username')); ?>" class="form-control" placeholder="<?php echo app('translator')->get('Username'); ?>" >
                    ...
                    <div class="form-group mb-4">
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="mb-2">
                          <a href="<?php echo e(url('user/password/reset')); ?>" class="small text-muted text-underline--dashed border-primary">Lost password?</a>
                        </div>
                      </div>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                        ...
                        <input type="password" name="password" value="<?php echo e(old('password')); ?>" class="form-control" id="myInput"  placeholder="<?php echo app('translator')->get('Password'); ?>">
                  ...
                  <a href="<?php echo e(url('user/register')); ?>" class="small font-weight-bold">Create account</a> Forget Your Password
                  <a href="<?php echo e(url('user/password/reset')); ?>" class="small font-weight-bold">Forget Password</a>
                  </div>
              </div>
            </div>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/user/auth/login.blade.php ENDPATH**/ ?>