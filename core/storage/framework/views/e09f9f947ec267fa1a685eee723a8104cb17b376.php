...
<head>
  ...
  <link type="text/css" href="<?php echo e(asset('assets_new/libs/@fancyapps/fancybox/dist/jquery.fancybox.min.css')); ?>" rel="stylesheet">
  <!-- Purpose CSS -->
...
<body>
            ...
            <ul class="nav">
              <li class="nav-item dropdown ml-lg-2">
                ...
                <div class="dropdown-menu dropdown-menu-sm">
                  ...
                  <a href="#" class="dropdown-item"><img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/icons/flags/gr.svg')); ?>">Greek</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div class="col-lg-6">
            <div class="card bg-dark opacity-container text-white overflow-hidden shadow border-0">
              <a href="#" data-fancybox data-type="iframe" data-src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.565017836055!2d-122.41879278507707!3d37.77679637975909!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter+HQ!5e0!3m2!1sen!2sro!4v1524131359924">
                <div class="card-img-bg" style="background-image: url(<?php echo e(asset('assets_new/img/theme/light/city-1.jpg')); ?>);"></div>
          ...
          <div class="col-lg-6">
            <div class="card bg-dark opacity-container text-white overflow-hidden shadow border-0">
              <a href="#" data-fancybox data-type="iframe" data-src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.8888618501214!2d-73.97667638497174!3d40.7644690793262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c258f07d5da561%3A0x61f6aa300ba8339d!2sThe+Plaza!5e0!3m2!1sen!2sro!4v1524131511734">
                <div class="card-img-bg" style="background-image: url(<?php echo e(asset('assets_new/img/theme/light/city-2.jpg')); ?>);"
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
                   <?php $__currentLoopData = $company_policy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $policy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li>
                         <a href="<?php echo e(route('home.policy',[$policy, str_slug($policy->value->title)])); ?>"> <?php echo e(__($policy->value->title)); ?>
  ...
  <!-- Page JS -->
  <script src="<?php echo e(asset('assets_new/libs/autosize/dist/autosize.min.js')); ?>"></script>
...
</html><?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/contact.blade.php ENDPATH**/ ?>