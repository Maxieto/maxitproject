            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <h5 class="card-header card-header-bg text-center" style="background-color: #a700ff;color: white;font-weight: bold;" ><?php echo e(__($data->name)); ?></h5>
                    ...
                    <div class="card-body card-body-deposit">
                         <img src="<?php echo e($data->methodImage()); ?>" class="card-img-top" alt="<?php echo e($data->name); ?>" style="width: 100%">
                     </div>
                    <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
                    <title><h5 class="card-header card-header-bg text-center" style="background-color: #a700ff;color: white;font-weight: bold;" ><?php echo e(__($data->name)); ?></h5> </title>
                    <defs></defs>
                    </div>
                    <div class="px-4 pb-5">
                    <button type="button"  data-id="<?php echo e($data->id); ?>" data-resource="<?php echo e($data); ?>" style="background-color: #a700ff;color: white;font-weight: bold;"
                             data-min_amount="<?php echo e(formatter_money($data->min_amount, $data->method->crypto())); ?>"  data-max_amount="<?php echo e(formatter_money($data->max_amount, $data->method->crypto())); ?>" data-fix_charge="<?php echo e(formatter_money($data->fixed_charge, $data->method->crypto())); ?>"
                                     data-percent_charge="<?php echo e(formatter_money($data->percent_charge, $data->method->crypto())); ?>"
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('user.deposit.insert')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="amount" type="text" class="form-control" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" name="amount" placeholder="0.00" required=""  value="<?php echo e(old('amount')); ?>">
                    ...
                    <div class="modal-footer">
                        <button type="submit" style="background-color: #a700ff;color: white;font-weight: bold;" class="btn btn-primary"><?php echo app('translator')->get('Confirm'); ?></button>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/user/deposit.blade.php ENDPATH**/ ?>