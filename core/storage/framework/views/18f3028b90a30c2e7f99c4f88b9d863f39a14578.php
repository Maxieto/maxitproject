                    ...
                    <tbody class="list">
                        <?php $__empty_1 = true; $__currentLoopData = $email_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('admin.email-template.edit', $template->id)); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                            </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/admin/email_template/index.blade.php ENDPATH**/ ?>