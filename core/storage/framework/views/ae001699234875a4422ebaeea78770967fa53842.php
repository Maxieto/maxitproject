                ...
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <?php if($data->fixed_amount == 0): ?>
                    ...
                    <?php endif; ?>
                       ...
                       <a href="javascript:void(0)"  style="color: black ;font-weight: bold; " data-toggle="modal" data-target="#depoModal"data-resource="<?php echo e($data); ?>"class="btn btn-sm btn-neutral mb-3 investButton"><?php echo app('translator')->get('Invest Now'); ?>
                            </a>
                     </div>
                    </div>
                   </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="ModalLabel"><?php echo app('translator')->get('Confirm to invest on'); ?> <strong class="planName text-white"></strong></h5>
                    <?php endif; ?>
                    <?php if(auth()->guard()->guest()): ?>
                    <h5 class="modal-title" id="ModalLabel"><?php echo app('translator')->get('Need Sign In'); ?> </h5>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="wallet_type">
                                    <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>"> <?php echo e(__(str_replace('_',' ',$data->type))); ?> (<?php echo e(formatter_money($data->balance)); ?> <?php echo e(__($general->currency)); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fixedAmount" id="fixedAmount" name="amount" value="<?php echo e(old('amount')); ?>" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger " data-dismiss="modal"><?php echo app('translator')->get('No'); ?></button>
                        </div>
                    <?php endif; ?>

                    <?php if(auth()->guard()->guest()): ?>
                        <div class="modal-footer">
                            <a href="<?php echo e(route('user.login')); ?>" type="button" class="btn btn-success custom-success" ><?php echo app('translator')->get('Please, Signin your account at first'); ?></a>
                        </div>
                    <?php endif; ?>
                </form>
            </div>
                                    ...
                                    <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-primary text-white"><?php echo e($data->name); ?>
                                        ...
                                        <div class="h1 text-primary text-center mb-0" data-pricing-value="12"><span class="price">
                                            ...
                                            <?php endif; ?>
                                                    ...
                                                    <?php elseif($data->capital_back_status == 1): ?>
                                                        <li style="margin-top: 8px" >
                                                        <span class="badge badge-warning"><?php echo app('translator')->get('Capital Will Store'); ?>
                                                        </span>
                                                        </li>
            ...
            <div class="modal-content ">
                ...
                <form action="<?php echo e(route('user.buy.plan')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="submit"  class="btn btn-success " ><?php echo app('translator')->get('Yes'); ?></button>
                            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><?php echo app('translator')->get('No'); ?></button>
                        </div>
                    <?php endif; ?>
...
<?php /**PATH /home2/stevejenkins/public_html/invest/core/resources/views/templates/minimal/plan.blade.php ENDPATH**/ ?>