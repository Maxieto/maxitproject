    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-dark bg-dark" id="navbar-main">
      <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="<?php echo e(url('/')); ?>">
          <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/brand/white.png')); ?>" id="navbar-logo" style="height: 100px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-main-collapse">
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item mr-0">
              ...
              <a href="<?php echo e(url('user/login')); ?>" target="_blank" class="btn btn-sm btn-white rounded-pill btn-icon rounded-pill d-none d-lg-inline-flex" data-toggle="tooltip" data-placement="left" title="Get Started">
    ...
    <section class="header-1 section-rotate bg-section-secondary" data-offset-top="#header-main">
      ...
      <div class="pt-7 position-absolute middle right-0 col-lg-7 col-xl-6 d-none d-lg-block">
        <figure class="w-100" style="max-width: 1000px;">
          <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/svg/illustrations/work-chat.svg')); ?>" class="svg-inject img-fluid" style="height: 1000px;">
        </figure>
      </div>
      <!-- SVG background -->
          ...
          <div class="row">
            <div class="col-lg-5 col-xl-6 text-center text-lg-left">
              ...
              <div>
                ...
                <div class="mt-5">
                  <a href="<?php echo e(url('user/register')); ?>" class="btn btn-white rounded-pill hover-translate-y-n3 btn-icon mr-sm-4 scroll-me">
                    <span class="btn-inner--text">Get Started</span>
                    <span class="btn-inner--icon"><i class="fas fa-angle-right"></i></span>
                  </a>
                  <a href="<?php echo e(url('user/register')); ?>" class="btn btn-outline-white rounded-pill hover-translate-y-n3 btn-icon d-none d-xl-inline-block scroll-me">
                    ...
                    <div class="container">
                      <div class="text-center">
                        ...
                        <div class="fluid-paragraph mt-4">
                          ...
                          <a href="<?php echo e(url('user/register')); ?>" class="btn btn-dark btn-icon rounded-pill hover-scale-110 mt-5">
   ...
   <!-- Features -->
              ...
              <div class="row row-grid align-items-center justify-content-around">
                <div class="col-lg-5">
                  <div class="img-back-shape">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/theme/light/innovation.png')); ?>" class="img-center img-fluid">
                  </div>
                </div>
                <div class="col-lg-5">
                  <div class="pr-md-4">
    ...
    <?php if($calculationCaption): ?>
      ...
      <div id="call-to-action-call-to-action-6" title="call-to-action/call-to-action-6.html">
            <section class="slice slice-xl bg-primary bg-cover bg-size--cover" style="background-image: url('<?php echo e(asset("assets/img/backgrounds/img-6.jpg")); ?>');">
            ...
            <div class="mb-5 text-center">
                  <h3 class="text-white mt-4">
                     <?php echo e(__(@$calculationCaption->data_values->title)); ?>

                    </h3>

                    <div class="fluid-paragraph mt-3">
                    <p class="lead lh-180 text-white"><?php echo e(@$calculationCaption->data_values->sub_title); ?></p>
                  </div></div>

            <form class="profit-form row justify-content-center">
                <div class="form-group col-sm-6 col-md-4 col-lg-3">
                    <h6 class="profil-title" style="font-weight: bold; color: white;" ><?php echo app('translator')->get('Plan'); ?></h6>
                    <select class="form-control select-bar" id="changePlan">
                        <option value=""><?php echo app('translator')->get('Choose Plan'); ?></option>
                ...
                <div class="form-group col-sm-6 col-md-4 col-lg-3">
                    <h6 class="profil-title" style="font-weight: bold; color: white" ><?php echo app('translator')->get('Invest Amount'); ?></h6>
                    <input type="text" placeholder="0.00" class=" form-control invest-input"
                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                </div>
                <div class="form-group col-sm-6 col-md-4 col-lg-3">
                    <h6 class="profil-title" style="font-weight: bold; color: white"><?php echo app('translator')->get('Profit'); ?></h6>
       ...
       <div>
         ...
         <div id="pricing-pricing-2" title="pricing/pricing-2.html">
           <section class="slice slice-lg">
             <div class="container">
               <div class="mb-5 text-center">
                 <h3 class=" mt-4"> <?php echo e(isset($planCaption->data_values->title)? __(@$planCaption->data_values->title):'Pricing plans'); ?></h3>
                 <div class="fluid-paragraph mt-3">
                   <p class="lead lh-180">
                   <?php echo e(isset($planCaption->data_values->short_details)? __(@$planCaption->data_values->short_details):"We'll make sure we build everything you need from now on"); ?>
            ...
            <div class="pricing card-group flex-column flex-lg-row mb-3">
                 <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row">
                     ...
                     <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-primary text-white"><?php echo e($data->name); ?>

                     </span>
                     <div class="card-header py-5 border-0">
                       <div class="h1 text-primary text-center mb-0" data-pricing-value="12"><span class="price">
                        <?php echo e(__($data->interest)); ?>%  <?php if($data->interest_status == 1): ?> <?php else: ?> <?php echo e(__($general->cur_text)); ?><?php endif; ?> /
                         </span>
                         <span class="h6 ml-2">
                         <?php echo e(__($time_name->name)); ?>

                           <?php if($data->interest_status == 1): ?>
                          <?php else: ?> <?php echo e(__($general->cur_text)); ?>

                           <?php endif; ?>
                                <?php if($data->capital_back_status == 1): ?>
                                 <li  style="margin-top: 8px">
                                      <span class="badge badge-success"><?php echo app('translator')->get('Capital Reimbursed'); ?></span>
                                    </li>
                                  <?php elseif($data->capital_back_status == 0): ?>
                                     <li style="margin-top: 8px" >
                                      <span class="badge badge-warning"><?php echo app('translator')->get('Capital is lost'); ?>
                                     </span>
                                    </li>
                     ...
                     <div class="card-body delimiter-top">
                       <ul class="list-unstyled mb-4">
                        <li>
                         <?php if($data->lifetime_status == 0): ?>
                                   <?php echo e(__($data->repeat_time)); ?> <?php echo app('translator')->get('Times'); ?> <?php else: ?> <?php echo app('translator')->get('Lifetime'); ?>
                                   <?php endif; ?>
                          </li>

                         <li><?php echo app('translator')->get('24/7Support'); ?></li>
                   <?php if($data->fixed_amount == 0): ?>
                       <li><?php echo app('translator')->get('Min.'); ?> <?php echo e(__($general->cur_sym)); ?><?php echo e(__($data->minimum)); ?>

                          <span><p><?php echo app('translator')->get('Max:'); ?> <?php echo e(__($general->cur_sym)); ?><?php echo e(__($data->maximum)); ?>

                          </p></span>
                       </li>
                    <?php else: ?>
                        <li><?php echo app('translator')->get('Invest Amount'); ?>: <?php echo e(__($general->cur_sym)); ?><?php echo e(__($data->maximum)); ?>

                        </li>
                    <?php endif; ?>

                       <a href="javascript:void(0)"  style="color: black ;font-weight: bold; " data-toggle="modal" data-target="#depoModal"data-resource="<?php echo e($data); ?>"class="btn btn-sm btn-neutral mb-3"><?php echo app('translator')->get('Invest Now'); ?>
                         </a>
                     </div>
                    </div>
                   </div>
                ...
                <div class="row row-grid align-items-center">
                  ...
                  <div class="col-lg-4">
                    <div class="position-relative" style="z-index: 10;">
                      <img alt="Image placeholder" src="<?php echo e(asset('assets_new/img/theme/light/iphone.png')); ?>" class="img-center img-fluid">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="d-flex align-items-start mb-5">
            ...
            <div>
              ...
              <div id="blog-blog-1" title="blog/blog-1.html">
                <section class="slice-xl delimiter-top">
                  <div class="container">
                    <div class="mb-5 text-center">
                      <h3 class=" mt-4"><?php echo e($blogCaption->data_values->title ? @$blogCaption->data_values->title:'In The New'); ?></h3>
                      <div class="fluid-paragraph mt-3">
                  <p class="lead lh-180"><?php echo e($blogCaption->data_values->short_details? @$blogCaption->data_values->short_details :''); ?></p></div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-5 mb-lg-0" data-animate-hover="1">
                          <div class="animate-this">
                             <a href="<?php echo e(route('home.blog.details',[str_slug($data->value->title),$data->id])); ?>">
                                <img   class="img-fluid rounded shadow"  src="<?php echo e(get_image(config('constants.frontend.blog.post.path').'/'.$data->value->image)); ?>" alt="<?php echo e($data->value->title); ?>">
                            </a>

                          </div>
                          <div class="pt-4">
                            <small class="text-uppercase"><?php echo e(date('d-M-Y', strtotime($data->created_at))); ?> </small>
                            <h5>
                              <a href="<?php echo e(route('home.blog.details',[str_slug($data->value->title),$data->id])); ?>"> <?php echo e(__(str_limit($data->value->title,30))); ?></a>
                            </h5>
                            <p class="mt-3">
                              <?php echo e(str_limit(strip_tags($data->value->body),100)); ?>
                ...
                <div class="modal-header">
                    <strong class="modal-title" id="ModalLabel">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php echo app('translator')->get('You must sign in to your Account'); ?>
                        <?php else: ?>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo e(route('user.login')); ?>" type="button"
                               class="btn btn-success custom-success"><?php echo app('translator')->get('Please, Sign in to your account first'); ?></a>
                        </div>
                    <?php endif; ?>
                </form>
            </div>
...
<?php /**PATH C:\xampp\htdocs\maxitproject\core\resources\views/templates/minimal/home.blade.php ENDPATH**/ ?>