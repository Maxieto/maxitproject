                        ...
                        <div class="col-lg-4">
                            <div class="card card-stats bg-gradient-info border-0 hover-shadow-lg hover-translate-y-n3 mb-4 ml-lg-0">
                                ...
                                <div class="d-flex">
                                    ...
                                    <span class="d-block h5 text-white mr-2 mb-1">{{ $general->cur_sym}} {{ formatter_money($data->balance) }} </span>
                                    <span class="text-white">{{__(str_replace('_',' ',strtoupper($data->type)))}} </span>
                                    </a>
                                    </div>
                                </div>
                                </div>
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="pl-4">
                      ...
                      <span class="d-block h5 text-white mr-2 mb-1">{{$general->cur_sym}}{{formatter_money($totalInvest)}}</span>
                      <span class="text-white">@lang('Total Invest')
                      </span>
                    </a>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="pl-4">
                      ...
                      <span class="d-block h5 text-white mr-2 mb-1">
                        {{$general->cur_sym}}{{formatter_money($totalWithdraw)}} </span>
              ...
              <div class="card card-stats bg-gradient-info border-0 hover-shadow-lg hover-translate-y-n3 mb-4 ml-lg-0">
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="pl-4">
                      <a href="{{route('user.deposit.history')}}" class="privacy-btn">
                      <span class="d-block h5 text-white mr-2 mb-1">{{$general->cur_sym}}{{formatter_money($totalDeposit)}} </span>
                      <span class="text-white">@lang('Total Deposit') </span>
                    </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="pl-4">
                      ...
                      <span class="d-block h5 text-white mr-2 mb-1">{{$totalTicket}}</span>
                      <span class="text-white">@lang('Total Ticket')</span>
                     </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/brand-avatar-1.png') }}" class="avatar  rounded-circle">
                    </div>
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/brand-avatar-2.png') }}" class="avatar  rounded-circle">
                    </div>
                    <div class="flex-fill pl-3 text-limit">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/brand-avatar-3.png') }}" class="avatar  rounded-circle">
                    </div>
                    <div class="flex-fill pl-3 text-limit">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/brand-avatar-4.png') }}" class="avatar  rounded-circle">
                    </div>
                    <div class="flex-fill pl-3 text-limit">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/brand-avatar-5.png') }}" class="avatar  rounded-circle">
                    </div>
                    <div class="flex-fill pl-3 text-limit">
