      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-9">            <!-- Article body -->
            <h5 style="text-align: center;">{{__($post->value->title)}} </h5>
            <article>
             <figure class="figure" >
                <img alt="Image placeholder" src="{{asset($data['image'])}}" alt="{{$data['title']}}"  style="margin-left: 56px;" class="img-fluid rounded">
                {{-- <figcaption class="mt-3 text-muted">Figure one: Type here your description</figcaption> --}}
              </figure>                          
              <p class="lead">{!! $post->value->body !!}</p>
