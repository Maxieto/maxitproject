                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Enable" data-off="Disable" name="id_verification_doc" @if($general_setting->id_verification_doc) checked @endif>
                        </div>

                        <div class="form-group col">
                            <label>Address Verification </label>
                            <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Enable" data-off="Disable" name="id_verification_address" @if($general_setting->id_verification_address) checked @endif>
                        </div>
