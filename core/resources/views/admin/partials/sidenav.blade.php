        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('admin.users*') }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item {{ sidenav_active('admin.users.documentunverfied') }}">
                        <a class="nav-link" href="{{ route('admin.users.documentunverfied') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Document Unverified</span>
                            @if($document_unverfied_users_count)
                            <span class="badge bg-blue border-radius-10">
                                {{ $document_unverfied_users_count }}</span>
                                 @endif
                        </a>
                    </li>
