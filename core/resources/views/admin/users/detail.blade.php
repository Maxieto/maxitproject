        ...
        <div class="card">
            ...
            <div class="card-body">
              ...
              <h6 style="text-align:center">
                @switch($user->id_verification_doc)
                    @case(1)
            ...
            <h6 style="text-align:center">Identity Document Font Image
                <div class="card-body text-center border-bottom">
                    <img src="{{ url('assets/images/doc') .'/'. $user->verification_doc }}" alt="profile-image" >
                    <h5 class="card-title mt-3">{{ $user->name }}</h5>
                </div>
            </h6>
                ...
                <h6 style="text-align:center">Identity Document Back Image
                    <div class="card-body text-center border-bottom">
                        <img src="{{ url('assets/images/doc') .'/'. $user->verification_doc_back }}" alt="profile-image" >
                        <h5 class="card-title mt-3">{{ $user->name }}</h5>
                    </div>
                </h6>
                ...
                <div class="card-body text-center border-bottom">
                    <img src="{{ url('assets/images/doc') .'/'. $user->verification_address_doc }}" alt="profile-image" >
                    <h5 class="card-title mt-3">{{ $user->name }}</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>First Name <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="first_name_doc" value="{{ $user->first_name_doc ??  '' }}" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Middle Name <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="middle_name_doc" value="{{ $user->middle_name_doc ?? '' }}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Last name <span class="text-danger">*</span></label>
                                <input class="form-control" type="last_name_doc" name="last_name_doc" value="{{ $user->last_name_doc ?? '' }}" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Date Of the Birth </label>
                                <input class="form-control" type="date" name="date_of_birth_doc" value="{{ $user->date_of_birth_doc  ?? '' }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-4">
                            <small>City</small>
                            <input class="form-control" type="city_doc" value="{{ $user->city_doc ?? '' }}" name="city_doc" placeholder="City">
                        </div>
                        <div class="form-group col-lg-4">
                            <small>street</small>
                            <input class="form-control" type="address_doc" value="{{ $user->address_doc ?? '' }}" name="address_doc" placeholder="State">
                        </div>
                        <div class="form-group col-lg-4">
                            <small>country </small>
                            <input class="form-control" type="text" value="{{ $user->country_doc ?? '' }}" name="country_doc" placeholder="Country ">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-12">
                            ...
                            <div class="row"  style="margin-top:20px" >
                                <div class="col-6">
                                    <a href="{{ url('admin/users/identityverification/'.$user->id.'/1') }}"  class="btn btn-primary btn-block">Accept</a>
                                </div>

                                <div class="col-6">
                                    <a href="{{ url('admin/users/identityverification/'.$user->id.'/0') }}"  class="btn btn-danger btn-block">Rejected</a>
                                </div>
