                 ...
                 @csrf
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control"  value="{{old('firstname')}}"  name="firstname"  id="input-password" placeholder="@lang('First Name')">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control"  value="{{old('lastname')}}"  name="lastname"  id="input-password" placeholder="@lang('Last Name')">
                        <div class="input-group-append">
                          <span class="input-group-text">
                          <i class="fas fa-user"></i>
                          </span>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" required class="form-control" id="input-email" name="username" value="{{old('username')}}"  placeholder="@lang('Username')">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="form-control-label">@lang('E-mail Address') </label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-user"></i></span>
                        </div>
                         <input type="email" required class="form-control" id="input-email" name="email"  value="{{old('email')}}" placeholder="@lang('E-mail Address')">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="password" name="password" value="{{old('password')}}" class="form-control" id="myInput"   placeholder="@lang('Password')" required >
                    ...
                    <div class="form-group">
                      <label class="form-control-label">@lang('Retype Password') </label>
                      <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                  ...
                  <a href="{{ url('user/login') }}" class="small font-weight-bold">Sign in</a></div>
              </div>
            </div>
