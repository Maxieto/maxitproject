...
<body>
  ...
  <div class="main-content">
    <!-- Header (v13) -->
    <section class="slice slice-xl bg-cover bg-size--cover pb-300" data-offset-top="#header-main" style="background-image: url({{ asset('assets_new/img/backgrounds/img-12.jpg')}} );">
...
{{--     <!-- Milestone (v1) -->
    <section class="slice slice-lg">
      <div class="container">
        <div class="mb-5 text-center">
          ...
          <h3 class=" mt-4">Just a few numbers</h3>
        ...
        <div class="position-relative">
          <div class="row">
            <div class="col-lg-3 col-6 mb-5 mb-lg-0">
              <div class="text-center">
                <div class="mb-4">
                  <img alt="Image placeholder" src="{{asset('assets_new/img/icons/essential/detailed/Group_2.svg') }}" class="svg-inject" style="height: 60px; width: auto;">
                </div>
            ...
            <div class="col-lg-3 col-6 mb-5 mb-lg-0">
              <div class="text-center">
                <div class="mb-4">
                  <img alt="Image placeholder" src="{{asset('assets_new/img/icons/essential/detailed/Help_1.svg') }}" class="svg-inject" style="height: 60px; width: auto;">
                </div>
                <div class="h1 text-primary">
            ...
            <div class="col-lg-3 col-6">
              <div class="text-center">
                <div class="mb-4">
                  <img alt="Image placeholder" src="{{asset('assets_new/img/icons/essential/detailed/Code_2.svg') }}" class="svg-inject" style="height: 60px; width: auto;">
                </div>
                <div class="h1 text-primary">
            ...
            <div class="col-lg-3 col-6">
              <div class="text-center">
                <div class="mb-4">
                  <img alt="Image placeholder" src="{{ asset('assets_new/img/icons/essential/detailed/Apps.svg') }}" class="svg-inject" style="height: 60px; width: auto;">
                </div>
                <div class="h1 text-primary">
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="row row-grid">
          ...
          <div class="col-lg-6">
            <div class="px-4">
              <img alt="Image placeholder" src="{{ asset('assets_new/img/theme/light/img-2-600x800.jpg') }}" class="img-fluid rounded shadow-lg hover-scale-110">
            </div>
          </div>
      ...
      <div class="container no-padding">
        ...
        <div class="card-deck">
          <div class="card hover-shadow-lg">
            <div class="card-body">
              <div class="delimiter-bottom pb-3 mb-4">
                <img alt="Image placeholder" src="{{ asset('assets_new/img/icons/essential/detailed/Desktop.svg') }}" class="svg-inject" style="height: 60px; width: auto">
          ...
          <div class="card hover-shadow-lg">
            <div class="card-body">
              <div class="delimiter-bottom pb-3 mb-4">
                <img alt="Image placeholder" src="{{ asset('assets_new/img/icons/essential/detailed/Mouse.svg') }}" class="svg-inject" style="height: 60px; width: auto">
 ...
 {{--    <section class="slice slice-lg bg-section-secondary delimiter-top delimiter-bottom">
              ...
              <div class="swiper-container" data-swiper-items="1" data-swiper-space-between="0">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="text-center">
                      <p class="h2 lh-160 text-gray font-italic font-weight-300" style="font-family: 'Playfair Display', serif;">"Amazing template! All-in-one, clean code, beautiful design, and really not hard to work with.Highly recommended for any kind on website."</p>
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="mb-5 text-center">
          <h3 class=" mt-4">{{$page_title}}</h3>
          <div class="fluid-paragraph mt-3">
            <p class="lead lh-180">@php echo $menu->value->body @endphp</p>
          </div>
        </div>
        <div class="row justify-content-center">
