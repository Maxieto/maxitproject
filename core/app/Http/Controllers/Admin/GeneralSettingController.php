...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->merge(['id_verification_address' => isset($request->id_verification_address) ? 1 : 0]);
        $request->merge(['id_verification_doc' => isset($request->id_verification_doc) ? 1 : 0]);
        ...
        $general_setting->update($request->only(['sitename', 'cur_text', 'cur_sym', 'ev', 'en', 'sv', 'sn', 'id_verification_address','id_verification_doc','reg', 'alert', 'bclr', 'sclr','deposit_commission','invest_commission','invest_return_commission','active_template']));
