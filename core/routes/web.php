...
Route::name('user.')->prefix('user')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('document_store', 'UserController@document_store')->name('document_store');


        Route::middleware('ckstatus')->group(function () {

            Route::get('dashboard', 'UserController@home')->name('home');
            Route::middleware('documentstatus')->group(function () {
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('users/document-unverfied', 'ManageUsersController@documentunverfied')->name('users.documentunverfied');
        ...
        Route::get('users/identityverification/{user_id}/{status}', 'ManageUsersController@identityverification');

        Route::get('users/addressVerification/{user_id}/{status}', 'ManageUsersController@addressVerification');
        // Login History
